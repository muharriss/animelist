...
const Intro = ({ api, index }) => {
  ...
  return (
    <div className="overflow-hidden rounded-md mt-2  relative ">
      ...
      {api.data ?
        <img
          src={api.data[index]?.trailer.images.maximum_image_url ? api.data[index]?.trailer.images.maximum_image_url: api.data[index]?.images.webp.large_image_url} className="h-[50vh] w-full  object-cover"
